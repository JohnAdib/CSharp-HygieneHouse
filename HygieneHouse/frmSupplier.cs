...
namespace HygieneHouse
{
    ...
    {
        JDBConnection objDBC = new JDBConnection("Supplier");
        ...
        {
            ClearBinding();
            txtSName.DataBindings.Add("Text", objDBC.objDataView, "SName");
            txtSAddress.DataBindings.Add("Text", objDBC.objDataView, "SAddress");
            txtSTel.DataBindings.Add("Text", objDBC.objDataView, "STel");
            RewriteListView();
        ...
        private void RewriteListView()
        {
            ...
            {
                lstData.Items.Add( TargetRow["SName"].ToString() ,TargetRow["SupplierID"].ToString());
            }
        }
        ...
        {   // Add each parameter to command
            ...
            objDBC.objCommand.Parameters.AddWithValue("@SName", txtSName.Text);
            objDBC.objCommand.Parameters.AddWithValue("@SAddress", txtSAddress.Text);
            objDBC.objCommand.Parameters.AddWithValue("@STel", txtSTel.Text);

            if (CommandType != CmdType.Insert)
                objDBC.objCommand.Parameters.AddWithValue("@SupplierID", this.BindingContext[objDBC.objDataView, "SupplierID"].Current);
        }
        ...
        {
            RunCommand(CmdType.Insert, "", "SName", "SAddress", "STel");
        }
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            RunCommand(CmdType.Update, "SupplierID", "SName", "SAddress", "STel");
        }
        private void btnDelete_Click(object sender, EventArgs e)
        {
            RunCommand(CmdType.Delete, "SupplierID", "SName", "SAddress", "STel");
        }
